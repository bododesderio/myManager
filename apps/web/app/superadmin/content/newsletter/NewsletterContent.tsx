  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={exportCsv}
          className="flex items-center gap-2 rounded-brand border border-border px-4 py-2 text-sm font-semibold text-text-2 transition hover:bg-bg-2"
        >
        ...
        <table className="w-full text-left text-sm">
          ...
          <tbody className="divide-y">
            {subscribers.map((subscriber) => (
              <tr key={subscriber.id} className="hover:bg-bg-2">
                ...
                <td className="px-4 py-3 text-text-2">{formatDate(subscriber.subscribed_at)}</td>
              </tr>
            ))}
