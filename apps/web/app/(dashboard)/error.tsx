  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 p-8 text-center">
      ...
      <div className="flex gap-3">
        ...
        <a
          href="/home"
          className="inline-flex items-center justify-center rounded-btn border border-border px-6 py-2.5 text-sm font-medium text-text transition-colors hover:bg-bg-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
        >
          Back to dashboard
        </a>
      </div>
